...
\begin{center}\includegraphics{ml4ec_workshop_files/figure-latex/unnamed-chunk-3-2} \end{center}
...
\caption{Visualization of a loss function as a plane spanned by the two parameters $x_1$ and $x_2$.}\label{fig:unnamed-chunk-22}
\end{figure}
